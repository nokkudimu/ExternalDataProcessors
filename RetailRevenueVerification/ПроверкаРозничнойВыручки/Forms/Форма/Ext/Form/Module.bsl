...
Процедура ОбновитьСписокНаСервере() 
	...
	|		        	СУММА(ЕСТЬNULL(ОтчетОРозничныхПродажахОплатаПлатежнымиКартами.Сумма, 0)) КАК СуммаБезнал,
	|		        	ОтчетОРозничныхПродажах.СуммаДокумента - СУММА(ЕСТЬNULL(ОтчетОРозничныхПродажахОплатаПлатежнымиКартами.Сумма, 0)) КАК СуммаНал
	|		        ПОМЕСТИТЬ ВТ_Основн
	|		        ИЗ
